...
gulp.task('build-example-bundle', function() {
	return browserify([ './example/example.shim.js', './lib/index.js' ], { standalone: 'Barchart.UserConfiguration' })
		.bundle()
...
gulp.task('lint', () => {
	return gulp.src([ './**/*.js', './test/specs/**/*.js', '!./node_modules/**', '!./docs/**', '!./test/SpecRunner.js', '!./example/**' ])
